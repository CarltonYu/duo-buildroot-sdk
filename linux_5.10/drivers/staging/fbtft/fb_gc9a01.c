...
/*
 * FB driver for the GC9A01 LCD Controller
 *
 * Copyright (C) 2025
 */
...
static int init_display(struct fbtft_par *par)
{
	...
	write_reg(par, 0x70, 0x07, 0x07, 0x04, 0x0E, 0x0F, 0x09, 0x07,
		  0x08, 0x03);
	write_reg(par, 0xE8, 0x34);
	write_reg(par, 0x62, 0x18, 0x0D, 0x71, 0xED, 0x70, 0x70, 0x18,
		  0x0F, 0x71, 0xEF, 0x70, 0x70);
	write_reg(par, 0x63, 0x18, 0x11, 0x71, 0xF1, 0x70, 0x70, 0x18,
		  0x13, 0x71, 0xF3, 0x70, 0x70);
	write_reg(par, 0x64, 0x28, 0x29, 0xF1, 0x01, 0xF1, 0x00, 0x07);
	write_reg(par, 0x66, 0x3C, 0x00, 0xCD, 0x67, 0x45, 0x45, 0x10,
		  0x00, 0x00, 0x00);
	write_reg(par, 0x67, 0x00, 0x3C, 0x00, 0x00, 0x00, 0x01, 0x54,
		  0x10, 0x32, 0x98);
	write_reg(par, 0x74, 0x10, 0x85, 0x80, 0x00, 0x00, 0x4E, 0x00);
	write_reg(par, 0x98, 0x3E, 0x07);
	write_reg(par, MIPI_DCS_SET_TEAR_ON);
